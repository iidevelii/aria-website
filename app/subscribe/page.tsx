    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', position: 'relative' }}>
      ...
      <div style={{ width: '100%', maxWidth: '560px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 style={{ fontSize: '36px', fontWeight: 900, marginBottom: '8px', color: 'var(--text)' }}>الاشتراك الاحترافي</h1>
          <p style={{ color: 'var(--muted)', fontSize: '15px' }}>35 USDT — 30 يوم وصول كامل بدون قيود</p>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: 'var(--muted)', fontSize: '14px' }}>لمدة 30 يوم كاملة</div>
          </div>
        ...
        <div className="glass-card" style={{ textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '22px', fontWeight: 800, marginBottom: '8px', color: 'var(--text)' }}>للاشتراك تواصل معنا</h2>
        ...
        <p style={{ textAlign: 'center', marginTop: '24px' }}>
          <Link href="/dashboard" style={{ color: 'var(--muted)', fontSize: '13px', textDecoration: 'none' }}>رجوع للداشبورد ←</Link>
        </p>
      </div>
    </div>
  )
