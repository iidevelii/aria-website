...
// ── Client Shell — كل التفاعلية (contexts, sidebar, ticker, auth gate) ────
// layout.tsx (Server Component) يلف هذا الكومبوننت عشان يقدر يصدّر metadata --
// نفس محتوى RootLayout سابقاً، بس بدون <html>/<head>/<body> (صار مكانهم بـlayout.tsx).
export default function ClientShell({children}:{children:React.ReactNode}) {
  ...
  return (
    <div style={{background:'var(--bg)',color:'var(--text)',visibility:mounted?'visible':'hidden'}}>
