...
export type Chapter = { id: string; name: L2; icon: string; color: string; sections: Section[] }

const botPatternTip: L2 = [
  'بوت DevelBot يكتشف هذا النمط تلقائياً على أكثر من 100 عملة — فعّله من أمر /patterns بتلقرام أو من صفحة منشئ الاستراتيجيات بالموقع.',
  'DevelBot automatically detects this pattern across 100+ coins — activate it via /patterns on Telegram or from the Strategy Builder page.',
]
const botIndicatorTip: L2 = [
  'هذا المؤشر من ضمن المؤشرات اللي يراقبها سكانر DevelBot لحظياً على كل عملة، وتقدر تبني شرط مخصص عليه من منشئ الاستراتيجيات.',
  'This indicator is one of the ones DevelBot\'s scanner tracks live on every coin — build a custom condition on it from the Strategy Builder.',
]
const botRiskTip: L2 = [
  'كل إشارة توصلك من DevelBot تجي جاهزة بالدخول والهدف والوقف محسوبين حسب هذا المبدأ بالضبط.',
  'Every signal you get from DevelBot arrives with entry, target, and stop loss already calculated using exactly this principle.',
]
    ...
    sections: [
      {
        ...
        concepts: [
          { id: 'double-top', name: ['القمة المزدوجة', 'Double Top'], diagram: 'double-top', tip: botPatternTip,
          ...
          { id: 'double-bottom', name: ['القاع المزدوج', 'Double Bottom'], diagram: 'double-bottom', tip: botPatternTip,
          ...
          { id: 'triple-top', name: ['القمة الثلاثية', 'Triple Top'], diagram: 'double-top', tip: botPatternTip,
          ...
          { id: 'triple-bottom', name: ['القاع الثلاثي', 'Triple Bottom'], diagram: 'double-bottom', tip: botPatternTip,
          ...
          { id: 'head-shoulders', name: ['رأس وكتفين', 'Head & Shoulders'], diagram: 'head-shoulders', tip: botPatternTip,
          ...
          { id: 'inv-head-shoulders', name: ['رأس وكتفين معكوس', 'Inverse Head & Shoulders'], diagram: 'head-shoulders', tip: botPatternTip,
      ...
      },
      {
        ...
        concepts: [
          { id: 'bull-flag', name: ['العلم الصاعد', 'Bullish Flag'], diagram: 'flag-bull', tip: botPatternTip,
          ...
          { id: 'bear-flag', name: ['العلم الهابط', 'Bearish Flag'], diagram: 'flag-bear', tip: botPatternTip,
          ...
          { id: 'bull-pennant', name: ['الراية الصاعدة', 'Bullish Pennant'], diagram: 'triangle-sym', tip: botPatternTip,
          ...
          { id: 'bear-pennant', name: ['الراية الهابطة', 'Bearish Pennant'], diagram: 'triangle-sym', tip: botPatternTip,
          ...
          { id: 'bull-rect', name: ['المستطيل الصاعد', 'Bullish Rectangle'], diagram: 'rectangle', tip: botPatternTip,
          ...
          { id: 'bear-rect', name: ['المستطيل الهابط', 'Bearish Rectangle'], diagram: 'rectangle', tip: botPatternTip,
      ...
      },
      {
        ...
        concepts: [
          { id: 'sym-triangle', name: ['المثلث المتماثل', 'Symmetrical Triangle'], diagram: 'triangle-sym', tip: botPatternTip,
          ...
          { id: 'asc-triangle', name: ['المثلث الصاعد', 'Ascending Triangle'], diagram: 'triangle-asc', tip: botPatternTip,
          ...
          { id: 'desc-triangle', name: ['المثلث الهابط', 'Descending Triangle'], diagram: 'triangle-desc', tip: botPatternTip,
          ...
          { id: 'rising-wedge', name: ['الوتد الصاعد', 'Rising Wedge'], diagram: 'wedge-rising', tip: botPatternTip,
          ...
          { id: 'falling-wedge', name: ['الوتد الهابط', 'Falling Wedge'], diagram: 'wedge-falling', tip: botPatternTip,
    ...
    sections: [
      {
        ...
        concepts: [
          { id: 'ma', name: ['المتوسطات المتحركة (SMA / EMA)', 'Moving Averages (SMA / EMA)'], tip: botIndicatorTip,
          ...
          { id: 'macd', name: ['الماك دي', 'MACD'], tip: botIndicatorTip,
      ...
      },
      {
        ...
        concepts: [
          { id: 'rsi', name: ['مؤشر القوة النسبية RSI', 'Relative Strength Index (RSI)'], tip: botIndicatorTip,
          ...
          { id: 'stochastic', name: ['مؤشر ستوكاستك', 'Stochastic Oscillator'], tip: botIndicatorTip,
      ...
      },
      {
        ...
        concepts: [
          { id: 'volume', name: ['الحجم (Volume)', 'Volume'], tip: botIndicatorTip,
      ...
      },
      {
        ...
        concepts: [
          { id: 'bollinger', name: ['بولنجر باند', 'Bollinger Bands'], diagram: 'bollinger', tip: botIndicatorTip,
    ...
    sections: [
      {
        ...
        concepts: [
          { id: 'support-resistance', name: ['الدعم والمقاومة', 'Support & Resistance'], diagram: 'support-resistance', tip: botRiskTip,
    ...
    sections: [
      {
        ...
        concepts: [
          { id: 'rr-ratio', name: ['نسبة المخاطرة إلى العائد', 'Risk-to-Reward Ratio'], tip: botRiskTip,
          ...
          { id: 'stop-loss', name: ['وقف الخسارة', 'Stop-Loss Order'], tip: botRiskTip,
