          ...
          <div className="academy-teaser-card" style={{
            ...
            <div style={{ position: 'relative', height: '260px' }}>
              <svg viewBox="0 0 340 260" style={{ width: '100%', height: '100%', display: 'block' }}>
                ...
                <path d="M 130 260 A 140 140 0 0 1 340 190 L 340 260 Z" fill="var(--yellow)" opacity="0.95" />
                ...
                <g transform="translate(150,60)">
                  ...
                  {/* خوذة/قبعة */}
                  <path d="M 12 48 A 28 28 0 0 1 68 48 L 68 54 L 12 54 Z" fill="var(--yellow)" />
                  <rect x="8" y="52" width="64" height="8" rx="4" fill="var(--yellow)" />
                  {/* ذراع تشاور على شارت */}
                ...
                <g transform="translate(205,95)">
                  ...
                  <circle cx="78" cy="10" r="5" fill="var(--green)" />
                </g>

                {/* عملة بيتكوين عائمة */}
                <g transform="translate(48,60)">
                  <circle r="22" fill="var(--yellow)" />
