...
export default function AboutPage() {
  ...
  const values = [
    ...
    { emoji: '⚙️', title: t('بلا أرقام وهمية', 'No fake numbers'), desc: t('ما نعرض أبداً أرباحاً غير مثبتة أو بيانات مصطنعة — أي بيانات توضيحية مُعلَّمة بوضوح كذلك.', 'We never display unproven profits or fabricated data — any illustrative data is clearly labeled as such.') },
  ]
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '28px', marginBottom: '32px', boxShadow: 'var(--shadow-card)' }}>
          <p style={{ color: 'var(--text)', fontSize: '14.5px', lineHeight: 1.9 }}>
            {t(
              'DevelBot بدأ كفكرة بسيطة: مراقبة مئات العملات الرقمية يدوياً كل يوم مهمة مستحيلة لأي متداول، بينما السوق يتحرك 24 ساعة بدون توقف. بنينا محرك تحليل آلي يفحص السوق باستمرار — أنماطاً، مؤشرات فنية، وهيكل السوق (Smart Money Concepts) — وعندما تظهر فرصة مطابقة لشروط محددة مسبقاً، يرسلها لك فوراً مع الدخول والأهداف ووقف الخسارة وسبب الاختيار، على الموقع وبوت تلقرام معاً.',
              "DevelBot started as a simple idea: manually watching hundreds of cryptocurrencies every day is an impossible task for any trader, while the market moves 24 hours a day without stopping. We built an automated analysis engine that continuously scans the market — patterns, technical indicators, and market structure (Smart Money Concepts) — and when an opportunity matching predefined criteria appears, it's sent to you instantly with entry, targets, stop loss, and the reasoning behind it, on both the website and the Telegram bot."
            )}
          </p>
        </div>
